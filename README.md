...
| [Определение возраста по фото](product_definition_by_picture) | Оценка возраста по фотографиям лиц людей. | *pandas*, *numpy*, *seaborn*, *matplotlib*, *tensorflow* |
...
| [Исследование объявлений о продаже квартир](research_of_apartment_sale_ads) |На основании архива объявлений о продаже кваритр в Санкт-Петербурге за несколько лет определим:
1. Рыночную стоимость объектов недвижемости
2. Параметры для потроения атоматизированной системы, отслеживающией аномалии и мошеннические действия.| *pandas*, *matplotlib* |
